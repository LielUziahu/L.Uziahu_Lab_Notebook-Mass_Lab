...
The relative fold-change results are visualized using a professional **Combo Chart** in Excel, combining column bars for individual gene fold changes with a dashed horizontal baseline to distinguish expression trends. The plot should be exported in vector **SVG format** (`qPCR_Excel_Fold_Change_Output.svg`) to preserve clean scaling and resolution on GitHub.

<img src="images/qPCR_Excel_Fold_Change_Output.svg" alt="qPCR Gene Expression Fold Change" width="100%">
